...
func NewStorage(mysqlConn *sql.DB) StorageI {
	return &storagePg{
		...
		restourantsRepo: mysql.NewRestourantsStorage(mysqlConn),
	}
}
...
func (s *storagePg) Restourants() repo.RestourantsI {
	return s.restourantsRepo
}
